...
#include "WzTabCtrl.h"
#include "MemDC.h"
#include "..\TabSiPlus\MdiChildManagment.h"
...
{
    ChildObject *pObject = (ChildObject *)GetItemData(uItemId);
    if((pObject != NULL) && (pObject->pSiWnd != NULL))
    {
        tooltip = pObject->strFullName.IsEmpty() ? pObject->strFileName : pObject->strFullName;
